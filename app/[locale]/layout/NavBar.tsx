          ...
          >
            <ul className="flex flex-col lg:px-6 lg:flex-row flex-1 lg:justify-center lg:items-center lg:space-y-0 lg:space-x-8">
              <li className="flex items-center p-2 border-t border-gray-200 md:border-t-transparent md:p-0">
                <Link href={`/${params.locale}#aboutUs`} className="text-[var(--dark-text-color)]">
                  {t('aboutUs')}
                </Link>
              </li>
              <li className="flex items-center p-2 border-t border-gray-200 md:border-t-transparent md:p-0">
                <Link href={`/${params.locale}#services`} className="text-[var(--dark-text-color)]">
                  {t('services')}
                </Link>
              </li>
              <li className="flex items-center p-2 border-t border-gray-200 md:border-t-transparent md:p-0">
                <Link href={`/${params.locale}#benefits`} className="text-[var(--dark-text-color)]">
                  {t('benefits')}
                </Link>
              </li>
              <li
              ...
              <li className="flex items-center p-2 border-t border-gray-200 md:border-t-transparent md:p-0">
                <Link href={`/${params.locale}#contact`} className="text-[var(--dark-text-color)]">
                  {t('contactUs')}
                </Link>
              </li>
            </ul>
            ...
            >
              <Link
                ...
                className="rounded bg-[var(--primary-button-bg-color)] px-4 py-2 text-[var(--primary-button-text-color)] hover:bg-[var(--primary-button-hover-bg-color)] hover:text-[#ffffff]"
              >
                {t('btnLogin')}
              </Link>
              <Link
                style={{ visibility: 'hidden' }}
                href="/login"
                className="rounded bg-[var(--secondary-button-bg-color)] px-4 py-2 text-[var(--dark-text-color)] hover:bg-[var(--primary-text-color)]"
              >
                {t('btnSignUp')}
              </Link>
            </div>
